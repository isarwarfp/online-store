...
var _appFastoptJs = require("./target/scala-3.3.3/app-fastopt.js");
const app = new (0, _appFastoptJs.OnlineStoreApp)();
app.doSomething("app");

},{"./target/scala-3.3.3/app-fastopt.js":"84IlN"}],"84IlN":[function(require,module,exports,__globalThis) {
'use strict';
...
/** @constructor */ function $c_Lcom_store_jobsboard_App() {
/*<skip>*/ }
$c_Lcom_store_jobsboard_App.prototype = new $h_O();
$c_Lcom_store_jobsboard_App.prototype.constructor = $c_Lcom_store_jobsboard_App;
/** @constructor */ function $h_Lcom_store_jobsboard_App() {
/*<skip>*/ }
$h_Lcom_store_jobsboard_App.prototype = $c_Lcom_store_jobsboard_App.prototype;
$c_Lcom_store_jobsboard_App.prototype.doSomething__T__V = function(containerId) {
    var container = document.getElementById(containerId);
    container.innerHTML = "Scala Here, with JS!";
};
$c_Lcom_store_jobsboard_App.prototype.$js$exported$meth$doSomething__T__O = function(containerId) {
    this.doSomething__T__V(containerId);
};
$c_Lcom_store_jobsboard_App.prototype.doSomething = function(arg) {
    var prep0 = $as_T(arg);
    return this.$js$exported$meth$doSomething__T__O(prep0);
};
var $d_Lcom_store_jobsboard_App = new $TypeData().initClass({
    Lcom_store_jobsboard_App: 0
}, false, "com.store.jobsboard.App", {
    Lcom_store_jobsboard_App: 1,
    O: 1
});
$c_Lcom_store_jobsboard_App.prototype.$classData = $d_Lcom_store_jobsboard_App;
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
exports.OnlineStoreApp = function() {
    return new $c_Lcom_store_jobsboard_App();
};
